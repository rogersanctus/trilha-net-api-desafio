...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            var tarefas = _context.Tarefas.Where(t => t.Titulo.ToUpper() == titulo.ToUpper());
        ...
        public IActionResult Criar(Tarefa tarefa)
        {
            ...
            var entry = _context.Tarefas.Add(tarefa);
            _context.SaveChanges();

            return CreatedAtAction(nameof(ObterPorId), new { id = entry.Entity.Id }, tarefa);
        }
